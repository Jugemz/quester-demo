...
let localAssetArrays = {
    priority: {
      low: {
        ...
        onCharacterSelect: {
          asset: [
              'resource/escape-identity-island/assets/cutscene/main.png',  
              'resource/escape-identity-island/assets/cutscene/badguy.png', 
          ],
          delay: 1200,
        },
        onCutsceneStart: {
          asset: [
              'resource/escape-identity-island/assets/activity/node/Mirror_Pond.png',
              'resource/escape-identity-island/assets/activity/node/Sandy.png',
              'resource/escape-identity-island/assets/activity/node/Cave.png',
              'resource/escape-identity-island/assets/activity/node/Truthful_Treasure.png',
              'resource/escape-identity-island/assets/activity/node/Palm_Grove.png',
              'resource/escape-identity-island/assets/activity/character/Crab.png',
              'resource/escape-identity-island/assets/activity/character/Stick.png',
              'resource/escape-identity-island/assets/activity/character/Paraclete.png',
              'resource/escape-identity-island/assets/activity/character/Fish.png',
              'resource/escape-identity-island/assets/activity/character/Lizard.png',
          ],
          delay: 1000,
        },
        onGameFinish: {
