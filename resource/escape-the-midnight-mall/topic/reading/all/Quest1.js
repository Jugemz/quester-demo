const resource =  {
    ...
    info: {
        ...
        path: "Identity_Island",
        logo: "resource/Identity_Island/assets/branding/preview-3rd-grade.png",
        ...
        /* the candy cave */
        {
            ...
            content: {
                ...
                crossword: {
                    ...
                    puzzle: [
    ["0","0","(G)H4","0","0","0","(A)Q","0","0","0","0","0"], 
    ["0","(H)H","E","0","(B)S","O","U","L1","0","0","0","(F)W"], 
    ["0","I2","A","0","(C)E","V","E","R","Y","0","0","A"], 
    ["(D)D","A","R","K","N","E","S","S","0","0","0","K"], 
    ["0","E","T5","0","0","0","(E)T","A","N","G3","L","E"], 
