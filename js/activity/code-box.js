function createCodeBox(){
  ...
  if (resource.challengeArray){
    codeNode = document.querySelector("#activity-node-" + resource.challengeArray.length);
  }
  // ✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅✅

  // ❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌
  else {
    codeNode = document.querySelector("#activity-node-" + resource.activityArray.length);
  }
  // ❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌
  ...
  codeBoxButton.addEventListener("click", function() {
    ...
    clearSplashContainer();
      ...
      setTimeout(toggleClass,((activityNodes.length * 200) + 500),splash,'splash--hidden','splash--visible');

      // toggle cutscene
      setTimeout(addCutscene,((activityNodes.length * 200) + 500),cutsceneOutroIndex,'outro',500);
      debriefStats.outcome = 'victory';
  });
  ...
  if (resource.challengeArray){
    for (let i = 0; i < resource.challengeArray.length-1; i++) {
      ...
      for (let j = 0; j < resource.challengeArray[i].questions.code.userArray.length; j++) {
