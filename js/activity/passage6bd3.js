function drawPassage() {
  // create aliases
  let activityPassage = resource.activityArray[activityArrayIndex-1].content.passage;
  let passageStyleMaterial = resource.activityArray[activityArrayIndex-1].content.passage.style.material;
  let passageStyleText = resource.activityArray[activityArrayIndex-1].content.passage.style.text;
